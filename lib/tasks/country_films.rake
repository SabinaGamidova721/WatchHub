namespace :country_films do
  ...
  task country_films: :environment do
    ...
    country_films_data = [
      # Pretty Woman
      {country_id: countries.find_by(country_name: "United States").id, film_id: films.find_by(title: "Pretty Woman").id},
      # Titanic
      ...
      # Don't Look Up
      {country_id: countries.find_by(country_name: "United States").id, film_id: films.find_by(title: "Don't Look Up").id},
      # The Devil Wears Prada
      {country_id: countries.find_by(country_name: "United States").id, film_id: films.find_by(title: "The Devil Wears Prada").id},
      # Mr. & Mrs. Smith
      ...
      # Terminator
      {country_id: countries.find_by(country_name: "United Kingdom").id, film_id: films.find_by(title: "Terminator").id},
      {country_id: countries.find_by(country_name: "United States").id, film_id: films.find_by(title: "Terminator").id},
      # Beauty and the Beast
      {country_id: countries.find_by(country_name: "United States").id, film_id: films.find_by(title: "Beauty and the Beast").id},
      # Harry Potter and the Philosopher's Stone
      {country_id: countries.find_by(country_name: "United Kingdom").id, film_id: films.find_by(title: "Harry Potter and the Philosopher's Stone").id},
      {country_id: countries.find_by(country_name: "United States").id, film_id: films.find_by(title: "Harry Potter and the Philosopher's Stone").id},
