class UserProfile < ApplicationRecord
  ...
  def self.ransackable_associations(auth_object = nil)
    ["avatar_attachment", "avatar_blob", "comments", "ratings", "user", "user_histories", "user_likes", "user_watch_laters"]
  end

  def self.ransackable_attributes(auth_object = nil)
    ["created_at", "date_of_birth", "date_of_registration", "id", "id_value", "nickname", "updated_at", "user_id"]
  end
end
