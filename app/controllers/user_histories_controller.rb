  ...
  def create
    ...
    respond_to do |format|
      if @user_history.save
        format.html { redirect_to user_history_url(@user_history), notice: "User history was successfully created." }
  ...
  def update
    respond_to do |format|
      if @user_history.update(user_history_params)
        format.html { redirect_to user_history_url(@user_history), notice: "User history was successfully updated." }
